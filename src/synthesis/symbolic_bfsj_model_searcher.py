...
from synthesis.symbolic_automata_encoder import SymbolicAutomataEncoder
...
def search(safety_automaton:Automaton,
           L_a:Automaton,
           L_g:Automaton,
           is_mealy,
    ...
    encoding_solver = SymbolicAutomataEncoder(logic,
                                              safety_automaton,
                                              L_a,
                                              L_g,
                                              underlying_solver,
